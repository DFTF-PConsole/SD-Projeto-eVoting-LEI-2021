...
/**
 * Excepção que é lançada quando uma Mesa de Voto registada corresponde a uma situação que não deveria ocorrer.
 *
 * @author Cláudia Campos
 * @version 1.0
 * @see Exception
 */
public class MesaVotoRegistadaException extends Exception {
     ...
     * @version 1.0
     */
    public MesaVotoRegistadaException(String message) {
        super(message);
    }
